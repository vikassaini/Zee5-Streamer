...
<meta charset="utf-8">
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="copyright" content="This Edited by Saksham Shekher">
...
<body>
  ...
  <h1 style="color:orange; text-align:center; cursor: pointer;"><a href="https://stremio.connectvip.workers.dev">ZEE5 HLS Streamer </a></h1>
...
<footer class="footer">
            <div class="container">
                <span class="copyright"><a style="text-decoration: none; color: #9C9AB3;" href="https://onepiece.ml">© 2021 Saksham Shekher</a></span>
            </div>
        </footer>
</body>
</html>`
        ...
        if (mainFetch.title == undefined) {
            return new Response(erhtml, {
                ...
                headers: ({
                    ...
                    "Edited-By": "https://github.com/Oshekher/Zee5-Streamer/"
                })
            })
        } else {
            var pass = ({
...
<head>
  <title>${title} | Saksham Shekher</title>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
